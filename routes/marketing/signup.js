...
const firstYearStudents = require("../../models/marketing/auth/mktFirstYear");
const secondYearStudents = require("../../models/marketing/auth/mktSecondYear");
const thirdYearStudents = require("../../models/marketing/auth/mktThirdYear");
const fourthYearStudents = require("../../models/marketing/auth/mktFourthYear");
