...
const firstYearFirstSemesterGrades = require("../../models/marketing/grades/firstYear/firstSemester");
const firstYearSecondSemesterGrades = require("../../models/marketing/grades/firstYear/secondSemester");
const firstYearThirdSemesterGrades = require("../../models/marketing/grades/firstYear/thirdSemester");

const secondYearFirstSemesterGrades = require("../../models/marketing/grades/secondYear/firstSemester");
const secondYearSecondSemesterGrades = require("../../models/marketing/grades/secondYear/secondSemester");
const secondYearThirdSemesterGrades = require("../../models/marketing/grades/secondYear/thirdSemester");

const thirdYearFirstSemesterGrades = require("../../models/marketing/grades/thirdYear/firstSemester");
const thirdYearSecondSemesterGrades = require("../../models/marketing/grades/thirdYear/secondSemester");
const thirdYearThirdSemesterGrades = require("../../models/marketing/grades/thirdYear/thirdSemester");

const fourthYearFirstSemesterGrades = require("../../models/marketing/grades/fourthYear/firstSemester");
const fourthYearSecondSemesterGrades = require("../../models/marketing/grades/fourthYear/secondSemester");
const fourthYearThirdSemesterGrades = require("../../models/marketing/grades/fourthYear/thirdSemester");
