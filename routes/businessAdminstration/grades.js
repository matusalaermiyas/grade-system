...
const firstYearFirstSemesterGrades = require("../../models/businessAdminstration/grades/firstYear/firstSemester");
const firstYearSecondSemesterGrades = require("../../models/businessAdminstration/grades/firstYear/secondSemester");
const firstYearThirdSemesterGrades = require("../../models/businessAdminstration/grades/firstYear/thirdSemester");

const secondYearFirstSemesterGrades = require("../../models/businessAdminstration/grades/secondYear/firstSemester");
const secondYearSecondSemesterGrades = require("../../models/businessAdminstration/grades/secondYear/secondSemester");
const secondYearThirdSemesterGrades = require("../../models/businessAdminstration/grades/secondYear/thirdSemester");

const thirdYearFirstSemesterGrades = require("../../models/businessAdminstration/grades/thirdYear/firstSemester");
const thirdYearSecondSemesterGrades = require("../../models/businessAdminstration/grades/thirdYear/secondSemester");
const thirdYearThirdSemesterGrades = require("../../models/businessAdminstration/grades/thirdYear/thirdSemester");

const fourthYearFirstSemesterGrades = require("../../models/businessAdminstration/grades/fourthYear/firstSemester");
const fourthYearSecondSemesterGrades = require("../../models/businessAdminstration/grades/fourthYear/secondSemester");
const fourthYearThirdSemesterGrades = require("../../models/businessAdminstration/grades/fourthYear/thirdSemester");
